 ...
 const [Customer, setCustomer] = useState([])
    ...
    useEffect(() => {
        const handleItems = async () => {
          try {
            const response = await axios.get('https://property-finder-backend.onrender.com/getcustomer');
      ...
      const handleDelete = async (id) => {
        try {
          await axios.delete(`https://property-finder-backend.onrender.com/deletecustomer/${id}`);
