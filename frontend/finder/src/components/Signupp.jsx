...
const handleSubmit =async(event)=>{
  ...
  const pemail=email;
    ...
    try{
    const display =await axios.post('https://property-finder-backend.onrender.com/createagent',{name,email, password,nationality,languages,experience,details,phone,profile})
