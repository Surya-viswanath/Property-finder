...
//   try {
//     const response = await axios.put(`https://property-finder-backend.onrender.com/updateList/${id}`, updates);
...
const handleUpdate = async (id) => {
  try {
    await axios.put(`https://property-finder-backend.onrender.com/updateList/${id}`, updatedData);
